...
import (
  ...
  _ "github.com/gmlewis/go-fonts-w/fonts/wcsoldoutcbta"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from wcsoldoutcbta"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "wcsoldoutcbta", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
