...
import (
  ...
  _ "github.com/gmlewis/go-fonts-w/fonts/woodennickelblack"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from woodennickelblack"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "woodennickelblack", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
