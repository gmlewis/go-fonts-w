...
import (
  ...
  _ "github.com/gmlewis/go-fonts-w/fonts/wcsoldoutbbta"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from wcsoldoutbbta"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "wcsoldoutbbta", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
