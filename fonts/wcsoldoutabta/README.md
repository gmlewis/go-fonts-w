...
import (
  ...
  _ "github.com/gmlewis/go-fonts-w/fonts/wcsoldoutabta"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from wcsoldoutabta"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "wcsoldoutabta", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
