...
import (
  ...
  _ "github.com/gmlewis/go-fonts-w/fonts/wellfleet_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from wellfleet_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "wellfleet_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
